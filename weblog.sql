...
(
   ...
   profile              varchar(100) comment '简介',
...
(
   id                   int unsigned not null auto_increment comment 'ID',
   title                varchar(20) not null unique key  comment '文章标题',
   profile              varchar(100) not null comment '文章简介',
...
(
   ...
   name                 varchar(20) not null unique key comment '分类名',
...
(
   ...
   is_read                tinyint unsigned comment '0未读,1已读',
   email                varchar(20) comment '你的email(可选)',
...
(
   ...
   name                 varchar(20) not null unique key comment '标签名',
   primary key (id)
);
...
(
   ...
   email                varchar(20) unique key comment '邮箱',
   password             char(70) not null comment '密码',
   head                 text comment '头像text，(可选)',
   oneword              varchar(50) comment '个性签名',
...
(
   id                   int unsigned not null auto_increment comment 'id',
   code                 varchar(20) unique key comment '权限码',
   name                 varchar(20) unique key comment '权限名',
...
(
   id                   int unsigned not null auto_increment comment 'id',
   name                 varchar(20) unique key comment '权限模块名',
...
(
   id                   int unsigned not null auto_increment comment 'id',
   name                 varchar(20) unique key comment '菜单名',
...
(
   id                   int unsigned not null auto_increment comment 'ID',
   name                 varchar(20) unique key comment '角色名',
...
(
   id                   int unsigned not null auto_increment comment 'ID',
   username             varchar(20) unique key comment '账号',
